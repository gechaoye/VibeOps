...
export function KnowledgeGraph({ appKey, onGoToWorkbench }: KnowledgeGraphProps) {
  ...
  return <main className="kg-workspace">
    ...
    <section className="kg-canvas-panel kg-demo-canvas-panel">
      <div className="kg-toolbar"><div className="kg-canvas-title"><Network size={15} /><strong>导航与功能关系图</strong></div><span className="kg-toolbar-hint">悬停节点查看一跳关系，拖动节点调整布局</span><button type="button" className="icon-button" title="适应画布" onClick={() => fitGraph?.()}><LocateFixed size={15} /></button></div>
